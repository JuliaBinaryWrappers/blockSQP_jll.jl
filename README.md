# `blockSQP_jll.jl` (v0.0.1+0)

[![deps](https://juliahub.com/docs/blockSQP_jll/deps.svg)](https://juliahub.com/ui/Packages/General/blockSQP_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/da29e20eb0419df503eb347f977d798d8c496b0b/B/blockSQP/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `blockSQP_jll.jl` have been built from these sources:

* git repository: https://github.com/djanka2/blockSQP.git (revision: `da05d3957b93bd55b9a7f08c859d302851056a6d`)
* git repository: https://github.com/mathopt/blockSQPWrapper.git (revision: `8d796eda6ceb986c2e04888176c6cb292b94011e`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/da29e20eb0419df503eb347f977d798d8c496b0b/B/blockSQP/bundled)

## Platforms

`blockSQP_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `blockSQP_jll.jl`:

* [`libcxxwrap_julia_jll`](https://github.com/JuliaBinaryWrappers/libcxxwrap_julia_jll.jl)
* [`qpOASES_jll`](https://github.com/JuliaBinaryWrappers/qpOASES_jll.jl)
